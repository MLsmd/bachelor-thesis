...
\path [line, dashed] (sender2.south) -- ($(sender2.south)!0.7!(audio2.north-|sender2.north)$) -| (audio2.north);
\path [line, dashed] (sender2.south) -- ($(sender2.south)!0.7!(audio2.north-|sender2.north)$) -| (traffic.40);
\path [line, dashed] (sender2.south) -- ($(sender2.south)!0.7!(audio2.north-|sender2.north)$) -| (etc.north);
\path [line, dashed] (sender2.south) -- ($(sender2.south)!0.7!(audio2.north-|sender2.north)$) -| (news.40);
