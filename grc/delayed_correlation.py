...
# Generated: Fri Oct 20 18:14:24 2017
##################################################
...
class delayed_correlation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._SNR_range = Range(-20, 60, 1, 5, 200)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, "/home/luca/Desktop/pure_dab.dat", False)
        self.blocks_complex_to_mag_1 = blocks.complex_to_mag(1)
        self.blocks_complex_to_arg_0 = blocks.complex_to_arg(1)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 10**((-34.0-SNR)/20.0), 0)
    ...
    def set_SNR(self, SNR):
        self.SNR = SNR
        self.analog_noise_source_x_0.set_amplitude(10**((-34.0-self.SNR)/20.0))
