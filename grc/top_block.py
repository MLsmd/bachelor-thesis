...
# Title: Top Block
# Generated: Wed Nov  1 11:34:44 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._doppler_range = Range(0.0, 500.0, 1.0, 0.0, 200)
        ...
        self.channels_fading_model_0 = channels.fading_model( 8, doppler/samp_rate, False, 4.0, 0 )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.channels_fading_model_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_freq_sink_x_0, 0))    
        self.connect((self.channels_fading_model_0, 0), (self.blocks_throttle_0, 0))    
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.channels_fading_model_0.set_fDTs(self.doppler/self.samp_rate)
